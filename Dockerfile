...
ARG ATB_SRV_P=${LEAVE_COMMENT_SRV_PORT}
...
ENV LEAVE_COMMENT_SRV_PORT=$ATB_SRV_P
...
#RUN rm -rf /tmp/leave-comment-srv
...
#VOLUME /root/.m2
ENTRYPOINT ["java", "-jar", "/root/.m2/repository/com/yukaju/leave-comment-srv/0.0.1/leave-comment-srv-0.0.1.jar"]
